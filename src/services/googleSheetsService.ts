...
class GoogleSheetsService {
  ...
  constructor() {
    ...
    this.webAppUrl = import.meta.env.VITE_GOOGLE_APPS_SCRIPT_URL || 'https://script.google.com/macros/s/AKfycbwa1B2H-j8-Fa_2E4DYFiCZVByHfflyj6ae2UZMFuh0UAqWjJpZ0kjbkiLrZZ1Z90gU/exec';
    ...
    console.log('🔍 URL CHECK: Should contain AKfycbwa1B2H-j8-Fa_2E4DYFiCZVByHfflyj6ae2UZMFuh0UAqWjJpZ0kjbkiLrZZ1Z90gU');
    console.log('🔍 URL contains correct ID:', this.webAppUrl.includes('AKfycbwa1B2H-j8-Fa_2E4DYFiCZVByHfflyj6ae2UZMFuh0UAqWjJpZ0kjbkiLrZZ1Z90gU'));
