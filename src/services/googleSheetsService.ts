...
class GoogleSheetsService {
  ...
  constructor() {
    ...
    this.webAppUrl = import.meta.env.VITE_GOOGLE_APPS_SCRIPT_URL || 'https://script.google.com/macros/s/AKfycbw24T-bvBAIP7ZfPtspEkntTjiT6OyC_hcHRQ4U94pNk_vtslu_e-NZctIuPRe21IPI/exec';
    ...
    console.log('🔍 URL CHECK: Should contain AKfycbw24T-bvBAIP7ZfPtspEkntTjiT6OyC_hcHRQ4U94pNk_vtslu_e-NZctIuPRe21IPI');
    console.log('🔍 URL contains correct ID:', this.webAppUrl.includes('AKfycbw24T-bvBAIP7ZfPtspEkntTjiT6OyC_hcHRQ4U94pNk_vtslu_e-NZctIuPRe21IPI'));
