...
class GoogleSheetsService {
  ...
  constructor() {
    ...
    this.webAppUrl = import.meta.env.VITE_GOOGLE_APPS_SCRIPT_URL || 'https://script.google.com/macros/s/AKfycbwm_KRe093XSMbjHohkcq0yitAi5arBxJGgL6mT34Ca9Z2zVj_M1SbP5wQ1gBBeU0tP/exec';
    ...
    console.log('🔍 URL CHECK: Should contain AKfycbwm_KRe093XSMbjHohkcq0yitAi5arBxJGgL6mT34Ca9Z2zVj_M1SbP5wQ1gBBeU0tP');
    console.log('🔍 URL contains correct ID:', this.webAppUrl.includes('AKfycbwm_KRe093XSMbjHohkcq0yitAi5arBxJGgL6mT34Ca9Z2zVj_M1SbP5wQ1gBBeU0tP'));
