...
class GoogleSheetsService {
  ...
  constructor() {
    ...
    this.webAppUrl = import.meta.env.VITE_GOOGLE_APPS_SCRIPT_URL || 'https://script.google.com/macros/s/AKfycbyD5DH7bPGln18qfBSUuJxgIMxM3Kz6Aap_TdowIAj9D-hNsnq1H-2CKG_gzF-PjwJ0/exec';
    ...
    console.log('🔍 URL CHECK: Should contain AKfycbyD5DH7bPGln18qfBSUuJxgIMxM3Kz6Aap_TdowIAj9D-hNsnq1H-2CKG_gzF-PjwJ0');
    console.log('🔍 URL contains correct ID:', this.webAppUrl.includes('AKfycbyD5DH7bPGln18qfBSUuJxgIMxM3Kz6Aap_TdowIAj9D-hNsnq1H-2CKG_gzF-PjwJ0'));
