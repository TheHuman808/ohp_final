...
class GoogleSheetsService {
  ...
  constructor() {
    ...
    this.webAppUrl = import.meta.env.VITE_GOOGLE_APPS_SCRIPT_URL || 'https://script.google.com/macros/s/AKfycbx_07-7r_cnaLaJwoHIlXrd8uU2z5YN6E4uajE1YLvx62cWHRcVYMzhWwYN2fOl6TP9/exec';
